...
function setup(){
  canvas = createCanvas(displayWidth,displayHeight);
    ...
    for (var i = displayWidth+100; i > displayWidth.x; i+20){

          obstacles.push(new Obstacles(displayWidth/2, i));
          Matter.Body.setVelocityX(obstacles.body, -50);
...
function draw(){
  ...
  Engine.update(engine);
    ...
    if (gameState === PLAY){
        ...
        for (var j = 0; j < displayWidth.x; j++){
